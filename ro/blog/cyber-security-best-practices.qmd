...
Pentru mai multe informații sau asistență în implementarea acestor practici, [contactați echipa noastră de securitate](/booking/){target="_blank"}.
...
::: {.text-center .mt-3}
[Înregistrați-vă acum](/booking/){target="_blank"}{.btn .btn-success}
:::
:::
:::
