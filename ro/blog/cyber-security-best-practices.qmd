...
Pentru mai multe informații sau asistență în implementarea acestor practici, [contactați echipa noastră de securitate](/ro/booking/){target="_blank"}.
...
::: {.text-center .mt-3}
[Înregistrați-vă acum](/ro/booking/){.btn .btn-success target="_blank"}
:::
:::
:::
