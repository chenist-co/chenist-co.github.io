...
```{=html}
<div style="margin: 2rem 0; padding: 2rem 2.5rem; background: rgba(245,166,35,0.06); border: 1.5px solid rgba(245,166,35,0.2); border-radius: 16px;">
<p style="margin: 0 0 0.5rem; font-weight: 600;">Enroll in Cyberhygiene Essentials</p>
<p style="margin: 0 0 1rem; font-size: 0.9rem; color: #86868b;">Access the full course on our learning platform — self-paced or instructor-led.</p>
<a href="https://chenist.trainercentralsite.eu/clientapp/app/course/35531000000003011/course-details" target="_blank" class="m-b" style="font-size: 0.95rem; padding: 0.7rem 2rem; background: #F5A623;"><i class="bi bi-box-arrow-up-right me-2"></i>Go to course</a>
</div>
```
...
<div class="m-cta">
  <div class="container">
    ...
    <div style="display:flex; gap:0.75rem; justify-content:center; flex-wrap:wrap;">
      <a href="https://chenist.trainercentralsite.eu/clientapp/app/course/35531000000003011/course-details" target="_blank" class="m-b" style="background:#F5A623;"><i class="bi bi-play-circle me-2"></i>Enroll now</a>
