...
format:
  html:
    other-links:
      - text: "Download PDF"
        href: cyber-security-best-practices.pdf
        icon: file-pdf
      - text: "Download ePub"
        href: cyber-security-best-practices.epub
        icon: book
  typst:
    toc: true
...
For more information or assistance with implementing these practices, [contact our security team](https://cal.com/chenist){target="_blank"}.
...
::: {.text-center .mt-3}
[Register Now](https://cal.com/chenist){.btn .btn-success target="_blank"}
:::
:::
:::