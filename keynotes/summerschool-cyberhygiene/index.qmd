...
# Cyber Hygiene for Students 2025 {.title-slide background-image="/assets/svg/learning.svg" background-size="cover"}
...
## Password Security for Students {.center background-image="/assets/svg/authentication.svg" background-size="cover"}
...
## Device Protection Strategies {.center background-image="/assets/svg/learning.svg" background-size="cover"}
...
## Social Media Security {.center background-image="/assets/svg/authentication.svg" background-size="cover"}
...
## Academic Data Protection {.center background-image="/assets/svg/learning.svg" background-size="cover"}
...
## Real-World Scenarios {.center background-image="/assets/svg/authentication.svg" background-size="cover"}
...
## Building Security Habits {.center background-image="/assets/svg/learning.svg" background-size="cover"}
...
## Final Exercise: Security Pledge {.center background-image="/assets/svg/authentication.svg" background-size="cover"}
