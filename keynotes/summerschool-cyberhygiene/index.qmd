...
# Session 1: Foundation Security {.center background-image="/assets/svg/secure_data.svg" background-size="cover"}
...
## Safe Browsing Practices {.center background-image="/assets/svg/secure_data.svg" background-size="cover"}
...
## Privacy Protection Techniques {.center background-image="/assets/svg/secure_data.svg" background-size="cover"}
...
## Emergency Response Plan {.center background-image="/assets/svg/secure_data.svg" background-size="cover"}
