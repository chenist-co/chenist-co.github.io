...
image: "/assets/images/thumb-mountains.svg"
format:
  revealjs:
    theme: dark
    logo: "/assets/images/icon.svg"
    footer: "© 2025 CHENIST | Open4Tech - Student Cyber Hygiene Course"
...
# Cyber Hygiene for Students 2025 {.title-slide background-image="/assets/svg/tortoise-shell.svg" background-size="cover"}

## Welcome to Cyber Hygiene course {.center}
...
::: {.notes}
These are speaker notes that won't appear on slides but will be visible in presenter mode.

- Remember to talk about the CHENIST Summerschool
- Remember to talk about the SpaceAppsChallenge 2025
- Don't forget to mention the upcoming demos
- Time check: this should take 5 minutes
:::

---

## Why Students Need Cyber Hygiene {.center}

::: {.fragment .fade-in}
### You're a high-value target. Why?
:::
...
# Session 1: Foundation Security {.center background-image="/assets/svg/flat-mountains.svg" background-size="cover"}

---

## Digital Threats in Student Life {.center background-image="/assets/svg/social_media.svg" background-size="cover"}
...
## Password Security for Students {.center background-image="/assets/svg/protruding-squares.svg" background-size="cover"}
...
## Device Protection Strategies {.center background-image="/assets/svg/tortoise-shell.svg" background-size="cover"}
...
## Safe Browsing Practices {.center background-image="/assets/svg/flat-mountains.svg" background-size="cover"}
...
# Session 2: Advanced Protection {.center background-image="/assets/svg/social_media.svg" background-size="cover"}

---

## Social Media Security {.center background-image="/assets/svg/protruding-squares.svg" background-size="cover"}
...
## Academic Data Protection {.center background-image="/assets/svg/tortoise-shell.svg" background-size="cover"}
...
## Privacy Protection Techniques {.center background-image="/assets/svg/flat-mountains.svg" background-size="cover"}
...
## Campus Network Security {.center background-image="/assets/svg/social_media.svg" background-size="cover"}
...
## Real-World Scenarios {.center background-image="/assets/svg/protruding-squares.svg" background-size="cover"}
...
## Building Security Habits {.center background-image="/assets/svg/tortoise-shell.svg" background-size="cover"}
...
## Emergency Response Plan {.center background-image="/assets/svg/flat-mountains.svg" background-size="cover"}
...
## Course Completion {.center background-image="/assets/svg/social_media.svg" background-size="cover"}

### Congratulations! 🎓

You now have the essential skills to:
- Protect your digital identity
- Secure your academic work
- Navigate threats safely
- Build lifelong security habits
...
## Final Exercise: Security Pledge {.center background-image="/assets/svg/protruding-squares.svg" background-size="cover"}
