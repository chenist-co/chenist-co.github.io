...
image: "/assets/images/thumb-constellation.svg"
format:
  revealjs:
    theme: dark
    logo: "/assets/images/logo-light.svg"
    footer: "© 2025 Open4Tech | NixOS for Cybersecurity Course"
...
# NixOS for Cybersecurity 2025 {.title-slide background-image="/assets/svg/endless-constellation.svg" background-size="cover"}
...
# Session 1: NixOS Fundamentals {.center background-image="/assets/svg/flat-mountains.svg" background-size="cover"}

---

## What is NixOS? {.center background-image="/assets/svg/large-triangles.svg" background-size="cover"}
...
## Declarative Configuration {.center background-image="/assets/svg/server.svg" background-size="cover"}
...
## Package Management with Nix {.center background-image="/assets/svg/endless-constellation.svg" background-size="cover"}
...
## System Hardening Basics {.center background-image="/assets/svg/flat-mountains.svg" background-size="cover"}
...
# Session 2: Advanced Security {.center background-image="/assets/svg/large-triangles.svg" background-size="cover"}

---

## Advanced Security Configurations {.center background-image="/assets/svg/server.svg" background-size="cover"}
...
## Network Isolation & Sandboxing {.center background-image="/assets/svg/endless-constellation.svg" background-size="cover"}
...
## Security Testing Environments {.center background-image="/assets/svg/flat-mountains.svg" background-size="cover"}
...
## Deployment Strategies {.center background-image="/assets/svg/large-triangles.svg" background-size="cover"}
...
## Real-World Scenarios {.center background-image="/assets/svg/server.svg" background-size="cover"}
...
## Building Security Habits {.center background-image="/assets/svg/endless-constellation.svg" background-size="cover"}
...
## Course Completion {.center background-image="/assets/svg/flat-mountains.svg" background-size="cover"}
...
## Final Exercise: Configuration Challenge {.center background-image="/assets/svg/large-triangles.svg" background-size="cover"}
