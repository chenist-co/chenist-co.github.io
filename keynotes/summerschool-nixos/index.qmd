...
## What is NixOS? {.center background-image="/assets/svg/code_review.svg" background-size="cover"}
...
# Session 2: Advanced Security {.center background-image="/assets/svg/code_review.svg" background-size="cover"}
...
## Deployment Strategies {.center background-image="/assets/svg/code_review.svg" background-size="cover"}
...
## Final Exercise: Configuration Challenge {.center background-image="/assets/svg/code_review.svg" background-size="cover"}
