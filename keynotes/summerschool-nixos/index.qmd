...
# NixOS for Cybersecurity 2025 {.title-slide background-image="/assets/svg/operating_system.svg" background-size="cover"}
...
# Session 1: NixOS Fundamentals {.center background-image="/assets/svg/secure_data.svg" background-size="cover"}
...
## Package Management with Nix {.center background-image="/assets/svg/operating_system.svg" background-size="cover"}
...
## System Hardening Basics {.center background-image="/assets/svg/secure_data.svg" background-size="cover"}
...
## Network Isolation & Sandboxing {.center background-image="/assets/svg/operating_system.svg" background-size="cover"}
...
## Security Testing Environments {.center background-image="/assets/svg/secure_data.svg" background-size="cover"}
...
## Building Security Habits {.center background-image="/assets/svg/operating_system.svg" background-size="cover"}
...
## Course Completion {.center background-image="/assets/svg/secure_data.svg" background-size="cover"}
